...
class AgilePilotNode:
    ...
    def min_obs_in_range_callback(self, markers_msg):
        ...
        rospy.loginfo_throttle(1.0, "self.obstacle_pos_list_num is %d", self.obstacle_pos_list_num)
        rospy.loginfo_throttle(1.0, "self.enough_obstacles is %d", self.enough_obstacles)
    ...
    def run_policy(self, state, obs_vec: np.array, acc_obs_vec: np.array, rl_policy=None):
        ...
        rospy.loginfo_throttle(5.0, "obs: %s", obs)
        # print("obs: ", obs)
        ...
        rospy.loginfo_throttle(5.0, "act: %s", action)
        rospy.loginfo_throttle(5.0, "inferece time: %f", rospy.get_time() - t)
